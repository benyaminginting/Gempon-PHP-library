...
class Gempon {
	...
	{	
		$this->config->load('gempon');
		$this->api_key 		= $this->config->item('gmn_api_key');;
		$this->api_secret = $this->config->item('gmn_api_key_secret');;
	}
  ...
  function send_notification($userid,$message,$link = '',$format = 'json'){
